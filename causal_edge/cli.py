...
from causal_edge.research.cli import probe_data as probe_data_command  # noqa: E402
...
def init(name):
    ...
    click.echo("")
    click.echo("Note:")
    click.echo("  This is a standalone causal-edge project scaffold with local sample data.")
