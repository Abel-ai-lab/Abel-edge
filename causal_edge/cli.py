...
def init(name):
    ...
    click.echo("  strategies.yaml          (3 synthetic demo strategies)")
    click.echo("  strategies/sma_crossover (synthetic SMA demo)")
    click.echo("  strategies/momentum_ml   (synthetic walk-forward GBDT demo)")
    click.echo("  strategies/causal_demo   (synthetic Abel graph voting demo)")
    click.echo("  CLAUDE.md + AGENTS.md    (agent harness)")
    click.echo("  .env.example             (Abel API key, optional)")
    click.echo("")
    click.echo("Note:")
    click.echo("  This is a standalone causal-edge project scaffold with synthetic demos.")
